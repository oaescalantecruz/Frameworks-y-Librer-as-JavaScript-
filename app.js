//1. Cambia el color del titulo y lo alterna
...
//2. Funcion para generar números aleatorios
...
//3. Valida si hay dulces que se eliminarán en una columna
...
//Pone los elementos caramelo en el tablero
function checkBoard() {
	fillBoard();
}
...
//7. interacción del usuario con el elemento caramelo es drag and drop
...
//hacer que el caramelo sea solido al moverse
...
//puntos 4 y 6. temporizador y boton reiniciar
